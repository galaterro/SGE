...
echo '<label for="usuario" class="col-sm-2 col-md-offset-2 control-label">Nombre de usuario</label>';
echo '<div class="col-sm-4">';
echo '<input type="text" name="usuario" placeholder="Nombre de Usuario" id="usuario" class="form-control"/>';
echo '</div></div>';
echo'<div class="form-group">';
echo '<label for="password" class="col-sm-2 col-md-offset-2 control-label">Contraseña</label>';
echo '<div class="col-sm-4">';
echo '<input type="password" name="password" placeholder="Password" id="password" class="form-control"/>';
echo '</div></div>';
echo'<div class="form-group">';
echo '<label for="dni" class="col-sm-2 col-md-offset-2 control-label">DNI</label>';
echo '<div class="col-sm-4">';
echo '<input type="text" name="dni" placeholder="DNI" id="dni" class="form-control"/>';
echo '</div></div>';
echo'<div class="form-group">';
echo '<label for="nombre" class="col-sm-2 col-md-offset-2 control-label">Nombre</label>';
echo '<div class="col-sm-4">';
echo '<input type="text" name="nombre" placeholder="Nombre" id="nombre" class="form-control"/>';
echo '</div></div>';
echo'<div class="form-group">';
echo '<label for="apellidos" class="col-sm-2 col-md-offset-2 control-label">Apellidos</label>';
echo '<div class="col-sm-4">';
echo '<input type="text" name="apellidos" placeholder="Apellidos" id="apellidos" class="form-control"/>';
echo '</div></div>';
echo'<div class="form-group">';
echo '<label for="telefono" class="col-sm-2 col-md-offset-2 control-label">Telefono</label>';
echo '<div class="col-sm-4">';
echo '<input type="text" name="telefono" placeholder="Num.Teléfono" id="telefono" class="form-control"/>';
echo '</div></div>';
echo'<div class="form-group">';
echo '<label for="cp" class="col-sm-2 col-md-offset-2 control-label">Código Postal</label>';
echo '<div class="col-sm-4">';
